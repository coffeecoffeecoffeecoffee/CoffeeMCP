class CoffeeMcp < Formula
  ...
  version "0.1.1"
  url "https://github.com/coffeecoffeecoffeecoffee/CoffeeMCP/releases/download/v#{version}/CoffeeMCP-v#{version}-macos.tar.gz"
  ...
  test do
    assert_match "coffee-mcp #{version}", shell_output("#{bin}/coffee-mcp --version")
  end
end
